...
course_details_urlpatterns = [
    ...
    path('similar/', course_views.CourseDetailSimilarView.as_view(),
         name="course/detail/similar"),

    # Registration on a course, for a student
    path('register', course_views.CourseRegisterView.as_view(),
         name="course/detail/register"),
    path('unregister', course_views.CourseUnregisterView.as_view(),
         name="course/detail/unregister"),

    # Activities: view (as student and as teacher), add, unlink and delete from a course
    path('activities', course_views.CourseDetailActivitiesView.as_view(),
         name="course/detail/activities"),
    path(
    ...
    path('activity/up', course_views.activity_on_course_up_view,
         name="course/detail/activity/up"),
    path('activity/add', course_views.ActivityCreateOnCourseView.as_view(),
         name="course/detail/activity/add"),
    path('activity/attach', course_views.ActivityAttachOnCourseView.as_view(),
         name="course/detail/activity/attach"),
    path('activity/unlink', course_views.activity_on_course_unlink_view,
         name="course/detail/activity/unlink"),
    path('activity/delete', course_views.activity_on_course_delete_view,
         name="course/detail/activity/delete"),

    # Collaborators: view, add and delete from a course
    path('collaborators', course_views.CourseDetailCollaboratorsListView.as_view(
    ), name="course/detail/collaborators"),
    ...
    path('students/', course_views.CourseDetailStudentsView.as_view(),
         name="course/detail/students"),
    path('students/add', course_views.CourseDetailStudentsAddView.as_view(),
         name="course/detail/students/add"),
    ...
    # Agora : view, add question
    path('agora', course_views.CourseDetailAgoraView.as_view(),
         name="course/detail/agora"),
    path('question/add', course_views.CourseDetailAgoraAddView.as_view(),
         name="course/detail/question/add"),
    path('question/<slug:question_slug>',
         course_views.CourseDetailAgoraQuestionAnswerView.as_view(), name="course/detail/question"),
    path('question/<slug:question_slug>/vote', course_views.CourseDetailAgoraQuestionAnswerVote.as_view(),
         name="course/detail/question/answer/vote"),

]

course_urlpatterns = [
    path('study/', course_views.CourseAsStudentListView.as_view(), name='course/my'),
    path('teach/', course_views.CourseAsTeacherListView.as_view(),
    ...
    path('update/<slug:slug>/',
         course_views.CourseUpdateView.as_view(), name='course/update'),
    path('delete/<slug:slug>/',
         course_views.CourseDeleteView.as_view(), name='course/delete'),
...
activity_details_urlpatterns = [
    ...
    path('resource/add', activity_views.ActivityCreateResourceView.as_view(),
         name="activity/detail/resource/add"),
    ...
    path('resource/detail/<slug:resource_slug>',
         activity_views.ResourceOnActivityDetailView.as_view(), name="activity/resource/detail"),

    # By which courses the activity is used
    path('usage/', activity_views.ActivityDetailUsageView.as_view(),
         name="activity/detail/usage"),

    # Activities similar to the current one
    path('similar/', activity_views.ActivityDetailSimilarView.as_view(),
         name="activity/detail/similar"),
...
activity_urlpatterns = [
    ...
    path('delete/<slug:slug>/',
         activity_views.ActivityDeleteView.as_view(), name='activity/delete'),
    path('update/<slug:slug>/',
         activity_views.ActivityUpdateView.as_view(), name='activity/update'),
...
resource_details_urlpatterns = [
    ...
    path('usage/', resource_views.ResourceDetailUsageView.as_view(),
         name="resource/detail/usage"),

    # Resources similar to the current one
    path('similar/', resource_views.ResourceDetailSimilarView.as_view(),
         name="resource/detail/similar"),
...
resource_urlpatterns = [
    ...
    path('delete/<slug:slug>/',
         resource_views.ResourceDeleteView.as_view(), name='resource/delete'),
    path('update/<slug:slug>/',
         resource_views.ResourceUpdateView.as_view(), name='resource/update'),
