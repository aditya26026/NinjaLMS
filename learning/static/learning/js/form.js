...
document.getElementById("id_access").addEventListener("click", function update_state_and_access_listener() {
...
if (add_form_exists) {
    function display_tab(tab_index) {
        ...
        if (current_tab_is_last_tab) {
            ...
            document.getElementById("finish_tab_btn").style.display = "none";
            ...
            if (current_tab_is_penultimate_tab) {
                document.getElementById("next_tab_btn").style.display = "none";
                document.getElementById("finish_tab_btn").style.display = "inline";
            } else {
                document.getElementById("next_tab_btn").style.display = "inline";
                document.getElementById("finish_tab_btn").style.display = "none";
            }
